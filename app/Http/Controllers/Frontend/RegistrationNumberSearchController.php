...
class RegistrationNumberSearchController extends Controller
{
    ...
    private function buildXlsx(Collection $participants): string
    {
        ...
        $zip->addFromString('xl/styles.xml', '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><fonts count="2"><font><sz val="11"/><name val="Calibri"/></font><font><b/><sz val="11"/><name val="Calibri"/></font></fonts><fills count="2"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill></fills><borders count="1"><border/></borders><cellStyleXfs count="1"><xf/></cellStyleXfs><cellXfs count="4"><xf fontId="0" fillId="0" borderId="0" xfId="0"/><xf fontId="1" fillId="0" borderId="0" xfId="0"/><xf fontId="1" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="center" vertical="top"/></xf><xf fontId="0" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment vertical="center"/></xf></cellXfs></styleSheet>');
    ...
    private function worksheetXml(Collection $participants, bool $hasImages): string
    {
        ...
        foreach ($rows as $rowIndex => $row) {
            ...
            foreach ($row as $columnIndex => $value) {
                ...
                $style = $rowIndex === 0 ? ' s="1"' : ($columnIndex === 1 ? ' s="2"' : ' s="3"');
